  ...
  <div id="app">
    ...
    <main class="main-content min-h-screen">
      ...
      <div class="w-full mx-auto">
        <nav class="flex justify-between items-center pt-4 w-full mx-auto">
          <div class="w-full ml-1 sm:ml-6">
            <RouterLink to="/" class="font-mono text-2xl" alt="logo">
              <img src="/logo.jpeg" alt="Logo" title="XJXVISUALS" role="img" aria-label="image" class=" max-w-20 block" />
            </RouterLink>
          </div>
