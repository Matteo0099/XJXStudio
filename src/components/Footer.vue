...
<template>
  <footer class="bg-[#da2228] text-neutral-50">
    <div class="max-w-screen-xl px-4 pt-16 pb-6 mx-auto sm:px-6 lg:px-8 lg:pt-24">
      <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
        <div>
          <div class="flex justify-center text-neutral-50 sm:justify-start">
            <img src="/logo.jpeg" alt="logo" role="img" width="150" height="150" class="rounded-lg"></img>
          </div>

          <p class="max-w-md mx-auto mt-6 leading-relaxed text-center text-neutral-50 sm:max-w-xs sm:mx-0 sm:text-left">
            Azienda creata da Versace Francesco nel 2025.
          </p>
          <p class="mt-4 mb-8 pb-4">
            <i>P.IVA: 01284720313</i>
          </p>
...
>>>>>>> Stashed changes
                ...
                <!-- <li>
                  <a class="flex group justify-center sm:justify-start gap-1.5" href="/">
                    ...
                    <span class="relative flex w-2 h-2 -mr-2">
                      <span
                        class="absolute inline-flex w-full h-full bg-green-500 rounded-full opacity-75 animate-ping"></span>
            ...
            <ul class="mt-8 space-y-4 text-sm">
              <li>
                <a class="flex items-center justify-center sm:justify-start gap-1.5 group" href="/">
                  ...
                  <span class="text-white transition group-hover:text-white/75">
                    <a href="mailto:xjxvisuals@gmail.com" class="email">xjxvisuals@gmail.com</a>
                  </span>
                </a>
              </li>
              ...
              <li>
                <a class="flex items-center justify-center sm:justify-start gap-1.5 group" href="/">
                  ...
                  <span class="text-white transition group-hover:text-white/75">
                    <a href="+393921141013" class="telephone">+39.392.114.1013</a>
                  </span>
                </a>
              </li>
              ...
              <li class="flex items-start justify-center gap-1.5 sm:justify-start">
                ...
                <address class="-mt-0.5 not-italic text-white">
                  Italy, Friuli-Venezia-Giulia, Monfalcone(GO) - cap.34074
                </address>
              </li>
            </ul>
          </div>
      ...
      <div class="pt-6 mt-12 border-t border-neutral-150">
        <div class="text-center sm:flex sm:justify-between sm:text-left">
          ...
          <span class="block sm:inline">All rights reserved <span>{{ time }}</span></span>

          <p class="mt-4 text-sm text-neutral-50 sm:order-first sm:mt-0">
            &copy; <span>{{ time }}</span> XJXvisuals
          </p>
        </div>
      </div>
    </div>
