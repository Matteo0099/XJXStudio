    ...
    <div class="container w-full h-full min-h-screen flex mt-6 justify-center flex-col mx-auto">
      ...
      <div class="container sticky w-full max-w-4xl px-4 mt-24 mx-auto flex flex-col justify-center items-center">
        <div class="relative min-h-screen w-full">
          ...
          <!-- about me -->
          <h1 class="mt-48 text-neutral-100 text-2xl sm:text-3xl font-black">
            ABOUT ME
          </h1>
          <div class="about text-neutral-50 w-full mt-4 flex flex-wrap sm:flex-nowrap">
            ...
            <div class="flex w-1/2 flex-col justify-center items-start">
              ...
              <div class="flex justify-between items-center flex-wrap sm:flex-nowrap w-full max-w-[365px] mt-8">
                <RouterLink to="/About">
                  <button id="myBtn"
                    class="flex justify-center hover:opacity-80 w-full sm:w-auto items-center font-black uppercase gap-2 text-sm mt-6 py-3 px-4">
                    About
                  </button>
                </RouterLink>
                <a href="mailto:">
                  <button
                    class="flex justify-center hover:opacity-80 border border-neutral-400 w-[150px] sm:w-[177px] accent uppercase font-black bg-transparent items-center gap-2 text-sm mt-6 sm:ml-2 py-3 px-4">
                    Contact me!
                  </button>
                </a>
              </div>
          ...
          <div class="container mx-auto mt-48 mb-24">
            ...
            <!-- cards -->
            <div
              class="flex w-full flex-col mx-auto sm:mx-0 sm:flex-row sm:justify-between flex-wrap sm:flex-nowrap mt-12">
              <!-- premium -->
              <div
                ...
                <div class="flex justify-between w-full max-w-40 mx-auto items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-premium-rights" width="44"
                    ...
                    <path d="M12 7v2" />
                    <path d="M12 15v2" />
                  </svg><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-premium-rights"
                ...
                <RouterLink to="/Services">
                  <button id="myBtn"
                    class="flex justify-center font-black uppercase items-center gap-2 text-sm mt-6 py-3 px-4">
                    checkout
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-arrow-right-bar"
                      width="28" height="28" viewBox="0 0 24 24" stroke-width="1.5" stroke="#fefefe" fill="none"
                      stroke-linecap="round" stroke-linejoin="round">
                      <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                      <path d="M18 15l3 -3l-3 -3" />
                      <path d="M3 12h18" />
