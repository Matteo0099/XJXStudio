<template>
  ...
  <div class="container z-[999] sticky w-full min-h-screen max-w-4xl px-4 mt-32 mx-auto">
    <div class="flex flex-col bg-white shadow-sm mx-auto border border-slate-200 rounded-lg my-6 min-h-[650px] max-w-[550px]">
      <div class="m-2.5 overflow-hidden rounded-md h-80 flex justify-center items-center">
        <img class="w-full h-full object-cover" src="../../public/logo.jpeg" alt="profile-picture" />
      </div>
